...
par.sim.cols    = 5;% Number of simulations 
...
load stnd_rbc_dyn\stnd_rbc_dyn_results oo_ M_;
DR              = oo_.dr;
DR.state_var    = M_.state_var;

%% Simulate with dynare:
par.sim.sol_typ = 'dyn';
SIM_d = stnd_rbc_sim_pert(par,SS,DR,par.sim,par.opt.order);
